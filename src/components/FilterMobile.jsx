...
const FilterMobile = ({ type, brands, handleFilter }) => {
  ...
  return (
    <div ref={ref} className="md:hidden relative">
      <button type="button" onClick={handleOpenFilter} className="inline bg-white text-neutral-500">
        <ListFilter />
      </button>

      {isOpen && (
        <div className="absolute left-0 shadow-xl right-40 sm:right-80 z-20 bg-white overflow-y-auto h-[calc(100vw-30px)] p-6">
          <div>
